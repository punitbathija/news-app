  ...
  return (
    <div className="flex flex-col gap-5 text-center justify-center justify-items-center px-0.5 md:px-16 md:py-16 font-bold">
      ...
      <div className="flex flex-col text-center align-middle justify-center md:mx-24 gap-3 md:flex-row">
        <div className=" flex card w-60 text-center justify-center bg-neutral text-neutral-content">
        ...
        <div className=" flex card w-60 text-center justify-center bg-neutral text-neutral-content mb-3">
          <div className="card-body items-center text-center">
            <h2 className="card-title">
              Entertainment
              <MdLocalMovies />
