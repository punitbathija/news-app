...
function Category() {
  return (
    <div className="flex flex-col md:gap-5 text-center justify-center justify-items-center md:px-16 py-16 font-bold">
      <h2 className="flex gap-3 text-center justify-center justify-items-center px-16 py-16 font-bold text-2xl">
        <Link href="/">
          <BiArrowBack />
        </Link>
